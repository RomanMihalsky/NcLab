...
import com.nc.mihalsky.factories.Factory;
...
class ValidatorDateEndOfUseTest {
  ValidatorDateEndOfUse validatorDateEndOfUse;
  Client client;
  Contract contract;

  @BeforeEach
  void init(){
    validatorDateEndOfUse = new ValidatorDateEndOfUse();
  ...
  void validateOk() throws NoSuchFieldException, IllegalAccessException {
    PatternError patternError = validatorDateEndOfUse.validate(contract);
  ...
  void validateError() throws NoSuchFieldException, IllegalAccessException {
    Field fieldDate = Contract.class.getDeclaredField("dateEndOfUse");
